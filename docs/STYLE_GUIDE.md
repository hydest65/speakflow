...
## 11. 0.2.1 local video test visual rule

During the single video test phase, the library should look intentionally sparse.
One video card is acceptable. Do not add filler cards, decorative previews, or
fake thumbnails to make the library feel fuller. The learning page remains the
primary surface for validating video playback, right side subtitles, and
close-reading notes.
